...
3. Execute the `git clone -b x/archived/legacy https://github.com/Aptivi/tools` command
   1. If you've initialized the Git repository for your project, you'll have to clone it as a submodule inside the root directory of your project using the `git submodule add -b x/archived/legacy https://github.com/Aptivi/tools` command and to push the commit.
